...
%% Load QPSK data
load('Con_QPSK_AWGN_KBS.mat', 'BER');
EbNo_BPSK_AWGN = 0:1:20;
BER_BPSK_AWGN = BER;

%% Load QPSK data
load('Con_QPSK_Fading_KBS.mat', 'BER');
EbNo_BPSK_Fading = 0:1:20;
BER_BPSK_Fading = BER;
...
%% Combine plots
figure;
semilogy(EbNo_BPSK_AWGN, BER_BPSK_AWGN, 'bo-', 'DisplayName', 'Experiment QPSK of AWGN');
hold on;
semilogy(EbNo_BPSK_Fading, BER_BPSK_Fading, 'ro-', 'DisplayName', 'Experiment QPSK of Fading Channel');
hold on;
